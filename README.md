...
![](docs/koboldcomforts/kobold-comforts-card.png)
...
- **Game Version**: 1.21.5
- **Type**: Content Mod
- **Supported Locales**: English (en), German (de), French (fr), Spanish (es), Danish (da), Norwegian (no), Swedish (sv), Japanese (ja), Chinese (zh), Ukrainian (uk)
